...
Public Class ValesRivera2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ControlValesAbarrotesRivera.ValesRivera2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValesRivera2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValesRivera2 = New ValesRivera2
        rpt.Site = Me.Site
        Return rpt
    End Function
