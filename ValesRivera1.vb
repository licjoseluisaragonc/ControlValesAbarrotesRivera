...
Public Class ValesRivera1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ControlValesAbarrotesRivera.ValesRivera1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedValesRivera1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ValesRivera1 = New ValesRivera1
        rpt.Site = Me.Site
        Return rpt
    End Function
